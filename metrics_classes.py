...
class AttackEvaluator:
    ...
    def evaluate(self, classification_time: float, output: str, prompt:str, **kwargs) -> AttackResult:
        """
...
class MetricsCalculator:
    ...
    def calculate_asr(self) -> Dict[str, Any]:
        ...
        attempted_attacks = [r for r in self.attack_results if r.attack_type != "blocked"]
    ...
    def calculate_time_to_classify(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "std_deviation": statistics.stdev(classification_times) if len(classification_times) > 1 else 0.0,
...
"""
    ...
    def evaluate(self) -> None:
        ...
        if "error" not in time_metrics:
            print("\nTIME-TO-CLASSIFY METRICS:")
            print(f"- Average Time: {time_metrics['average_time_to_classify']:.2f} seconds")
            print(f"- Median Time: {time_metrics['median_time_to_classify']:.2f} seconds")
            ...
            print(f"- Total Classification Time: {time_metrics['total_classification_time']:.2f} seconds")
        else:
            print("\nTIME-TO-CLASSIFY METRICS:")
